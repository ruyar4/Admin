...
ActiveRecord::Schema.define(version: 20150203235416) do
  ...
  add_index "gpsandsensors", ["phone_id"], name: "index_gpsandsensors_on_phone_id", using: :btree
  ...
  add_index "phones", ["gpsandsensor_id"], name: "index_phones_on_gpsandsensor_id", using: :btree
